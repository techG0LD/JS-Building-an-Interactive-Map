...
// Create map
const myMap = L.map('mapID').setView([48.868672, 2.342130], 12);
...
let polygon = L.polygon(latlngs, {
    color:'blue',
    fill : false  //or fillOpacity to remove the fill color of polygon
}).addTo(myMap)
...
const redPin = L.icon({
    iconUrl: './assets/red-pin.png', //use relative path but change public to '.' and change to forward slashes
    iconSize: [38,38],
    iconAnchor: [19,38]
...
const rS = L.marker([48.866200610611926, 2.352236247419453], {icon: redPin}).bindPopup('RÃaumur-SÃbastopol')
